...
function Schedule({title , inputText , active , start_day, setStart_day, end_day, setEnd_day}) {
    return (
                    ...
                    {inputText ? (
                        <Grid container variant='div' component="div" sx={{ display: "flex", marginTop: "20px" }}>
                            <Grid xl={4} xs={12} lg={5} item variant='div' component="div">
                                ...
                                <input value={start_day} onChange={(e) => setStart_day(e.target.value)} style={{ color: "white", background: "transparent", padding: "9px", border: "1px solid white", borderRadius: "5px" }} type='number' id='StartDate' />
                            </Grid>
                            <Grid className='mt-2 mt-lg-0  ms-xl-4 ms-0' item xl={4} lg={5} xs={12} variant='div' component="div">
                                ...
                                <input value={end_day} onChange={(e) => setEnd_day(e.target.value)} style={{ color: "white", background: "transparent ", padding: "9px", border: "1px solid white", borderRadius: "5px" }} type='number' id='EndDate' />
                            </Grid>
                        </Grid>
                    ) : null}
                </Typography>
