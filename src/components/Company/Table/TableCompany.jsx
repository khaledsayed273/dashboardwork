...
import useCompanyTable from '../../../Api/useCompanyTable';

function TableCompany() {
    const { rows, columns } = useCompanyTable()
                            ...
                            return (
                                <TableRow className='tableClientBody' sx={{
                                    ...
                                    {columns.map((column) => {
                                        ...
                                        return (
                                            <TableCell key={column.id} align={column.align} sx={{ color: "white ", borderRight: 0, borderLeft: 0 , }}>
